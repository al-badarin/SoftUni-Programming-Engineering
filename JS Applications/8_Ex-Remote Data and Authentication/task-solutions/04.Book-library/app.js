...
function createHtmlBook(book, id) {
    let titleTd = createElements('td', { class: 'title' }, book.title);
    let authorTd = createElements('td', { class: 'author' }, book.author);

    let editBtn = createElements('button', undefined, 'Edit');
    editBtn.addEventListener('click', handleEdit);

    let deleteBtn = createElements('button', undefined, 'Delete');
    deleteBtn.addEventListener('click', deleteBook);

    let buttonsTd = createElements('td', undefined, editBtn, deleteBtn);
    let tr = createElements('tr', { class: 'book' }, titleTd, authorTd, buttonsTd);
    tr.dataset.id = id;
    return tr;
}
