...
export const create = (model, imageUrl, year, mileage, contact, about) => request.post(baseUrl, model, imageUrl, year, mileage, contact, about);

export const edit = (motorcycleId, model, imageUrl, year, mileage, contact, about) => request.put(`${baseUrl}/${motorcycleId}`, model, imageUrl, year, mileage, contact, about);
